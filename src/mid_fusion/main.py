...
def get_args_old():
    ...
    parser.add_argument(
        "--data_path",
        type=str,
        default="/data/amathur-23/DADA/InTheWild/release_in_the_wild/",
    ...
    parser.add_argument(
        "--dataset_config",
        type=str,
        default="mid_fusion/configs/inthewild_full.yaml",
    ...
    parser.add_argument(
        "--gpu_id", type=int, default=1, help="ID of the GPU to use for training"
    )
    ...
    parser.add_argument(
        "--text_model_path", type=str, default=None, help="Path to the text model"
    )
    parser.add_argument(
        "--speech_model_name",
        type=str,
        default=None,
        help="Name of the speech model to use",
    )
    parser.add_argument(
        "--speech_model_path",
        type=str,
        default="/data/amathur-23/DADA/models/SpeechEmbedder/triplet_cosine_epsP35_51v2/best_model.pth",
    ...
    parser.add_argument(
        "--mlp_layers", type=int, default=2, help="Number of layers in MLP head"
    )
    parser.add_argument(
        "--hidden_layers",
        type=lambda s: [int(item) for item in s.split(",")],
        default="-1",
        help="List of hidden layer sizes for the model",
    )
    # /home/infres/iivanova-23/DADA/iivanova-23/models/google-t5/final
    parser.add_argument(
        "--fusion_strategy",
        type=str,
        choices=["mid", "conditional_late", "late", "audio"],
        default="mid",
    ...
    parser.add_argument(
        "--asv_root_dir",
        type=str,
        default="/data/amathur-23/DADA/ASVspoof2021_DF_eval",
        help="Root directory for ASV data",
    )
    parser.add_argument(
        "--asv_meta_dir",
        type=str,
        default="/data/amathur-23/DADA/ASVspoof2021_DF_eval/keys/DF/CM/trial_metadata.txt",
        help="Metadata directory for ASV data",
    )
...
def get_args():
    ...
    parser.add_argument(
        "--config_file",
        type=str,
        default="mid_fusion/runs/default.yaml",
