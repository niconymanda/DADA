"""
Dataset classes for 
1. CommonVoice dataset : CommonVoiceDataset
2. RAVDESS dataset : RAVDESSDataset
3. ASVspoof 2021 dataset : ASVSpoof21Dataset
4. In the Wild dataset : InTheWildDataset
"""
...
class CommonVoiceDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.return_transcription:
            y = self.id_to_transcription[idx]
            return x, y
        return x
