...
def main(args):
    ...
    spoofed_test_dataset = AuthorTripletLossDataset(spoofed_data, args.model_name, mode = 'spoof')
    ...
    # path = '/data/iivanova-23/output/n_authors_10/google-t5/best_t5_10/final.pth'
