...
# nohup python ./authorship_attribution/main.py --model_name 'answerdotai/ModernBERT-large' --learning_rate 1e-04 --margin 0.5  --batch_size 16  --hidden_layers "-1, -2, -3" --mlp_layers 3 --data "/data/iivanova-23/wiki/wiki_quotes.csv" --text_model_path "/data/iivanova-23/output/voxceleb2/answerdotai/ModernBERT-large_16_20_20250211-005900/final.pth" > bert_1.txt 2>&1 
# disown	
