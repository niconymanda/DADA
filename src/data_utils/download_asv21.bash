...
tar -xvf ASVspoof2021_DF_eval_part00.tar.gz 
tar -xvf ASVspoof2021_DF_eval_part01.tar.gz 
tar -xvf ASVspoof2021_DF_eval_part02.tar.gz 
tar -xvf ASVspoof2021_DF_eval_part03.tar.gz 
