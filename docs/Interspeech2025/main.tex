...
by the generator \todo{citation needed}, which is a major source of
...
\todo[inline]{See Section \ref{sec:late-fusion} after the bibliography for a math description of late fusion}
...
% We then add a binary classification head to the model and fine-tune it on the ASVspoof19 LA~\cite{ASVspoof_19} (Logical Access) dataset.

\todo[inline]{Abhay: might want to shift voxceleb2 desc to text module}
...
(EER).
% , and tandem assessment Detection Cost Function(t-DCF).
